...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/16 18:15:41 by fbbot             #+#    #+#             */
/*   Updated: 2025/03/17 15:07:38 by snidbell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				c_util(t_intersections *xs, double c, t_ray ray,
						t_object *obj);
...
void				ve_co_normal(t_point p, t_vector *w_n, t_vector o_n,
						t_object obj);
void				ve_cy_normal(t_point p, t_vector *w_n, t_vector o_n,
						t_object obj);
...
t_color				shade_hit(t_scene, t_compute cmp,
...
t_color				reflect_color(t_compute cmp, t_scene s,
						int reflect_recur_checker);
long				rgb_to_hex(t_color c);
t_color				lighting(t_scene s, t_compute cmp, t_light light,
						bool shade);
