...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/16 16:18:43 by snidbell          #+#    #+#             */
/*   Updated: 2025/03/16 16:18:44 by snidbell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minirt.h"

t_matrix	transf_ma(double thetha, t_matrix u_cross, t_matrix u_cross_square);
